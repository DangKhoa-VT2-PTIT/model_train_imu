...
char *ssid = "Manh Hai";     // Tên mạng WiFi của bạn
char *password = "0363266520";             // Mật khẩu mạng WiFi của bạn

const char *host = "192.168.1.139";     // Địa chỉ IP của máy tính chạy server
...
const int maxNumSample = 1000;  // Số dữ liệu lấy tối đa
